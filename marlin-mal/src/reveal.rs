...
{
    type Base =
    ConsistencyCheckProof<<E as PairingEngine>::Fr, MarlinKZG10<E, DensePolynomial<<E as PairingEngine>::Fr>>>;
    struct_reveal_simp_impl!(ConsistencyCheckProof; w_at_s, eval_proof);
}
